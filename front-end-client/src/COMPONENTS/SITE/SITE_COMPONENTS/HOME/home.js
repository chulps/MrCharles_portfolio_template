...
class Home extends React.Component {
    ...
    render() {
      ...
      return this.state.profile ? ( <
        ...
        /h1> <
        img className = "me fixed whole md-half"
        src = {
          images("./" + this.state.profile.picture)
        }
        alt = {
        ...
        <
        /div> <
        div className = "two-thirds mb30 relative"
        style = {
          {
        ...
        <
        video className = "laptop-project-video"
        controls loop src = {
          Clicktool
        }
        /> <
        /div> <
        Link className = "clicktool-project-button"
        to = "/projects/clicktool" >
        <
