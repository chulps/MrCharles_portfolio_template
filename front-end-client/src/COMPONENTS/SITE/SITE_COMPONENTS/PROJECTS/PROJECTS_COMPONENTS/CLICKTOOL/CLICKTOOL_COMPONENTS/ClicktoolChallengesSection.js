        ...
        <div className="sticky-top relative pl30 pr30 pb30">
          ...
          <div>
            ...
            <p className="whole sm-four-fifths md-half lg-third xl-fourth">
              Create an app designed for digital marketers where users can track
              and analyze their digital marketing campaigns, purchase phone
              numbers, purchase domains, build landing pages, and more.
            </p>
          </div>
        </div>
      </section>
